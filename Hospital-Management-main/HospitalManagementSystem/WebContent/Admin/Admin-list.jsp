...
<jsp:include page="../Admin/AdminHeader.jsp"></jsp:include>
    ...
    <main class="main">
        <div class="welcome-message">
            <h2>Welcome to the Hospital Management Page!</h2>
        </div>
        <div class="cta-buttons">
            <a href="<%= request.getContextPath() %>/register/register-update.jsp">Update Profile</a>
            <a href="<%= request.getContextPath() %>/register/register.jsp">Add Doctors</a>
            <a href="<%= request.getContextPath() %>/slots">Manage Slots</a>
        </div>
    </main>
